...
> 本文LaTeX模板主要来自全国大学生数学建模竞赛 LaTeX 论文模板  QQ 群：640633524
...
1. 如果需要去掉封面并把论文标题保留在摘要上面，在加载类的使用如下语句：
   ```
...
2. 另外本文的模板仅适用于2020数学建模，若往后届有新的格式要求，应及时使用新的模板，或直接修改cls文件的格式要求即可，也鼓励大家多去[LaTeX工作室](https://www.latexstudio.net/)建设环境.
